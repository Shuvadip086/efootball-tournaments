...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen neon-photo-bg flex items-center justify-center p-4 relative">
      <div className="field-accent-top absolute top-0 left-0 right-0" />
      <div className="w-full max-w-md relative">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-indigo-600 rounded-2xl mb-4 shadow-2xl shadow-indigo-900/60 ring-2 ring-indigo-400/30">
            <span className="text-3xl trophy-shine">⚽</span>
          </div>
          <h1 className="text-3xl font-black match-day-text drop-shadow-lg">eFootball Tournaments</h1>
          <p className="text-gray-300 text-sm mt-1 drop-shadow">Organize & track your tournaments</p>
        </div>

        {/* Card */}
        <div className="bg-gray-900/90 backdrop-blur-md rounded-2xl border border-indigo-900/40 overflow-hidden shadow-2xl shadow-black/60">
          {/* Tabs */}
